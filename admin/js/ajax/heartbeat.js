import { updatePostStatus, updateStatuses, updateTicker } from './page-elements';
 ...
 */
export const requestStatuses = ( event, data ) => { data.gpalab_feeder_count = 1; };
...
/**
 * Appends the gpalab_feeder_sync_status property to the data sent to the server by the heartbeat API.
...
export const requestStatus = ( _, data ) => {
  ...
  if ( id ) {
    data.gpalab_feeder_sync_status = id;
  }
};
