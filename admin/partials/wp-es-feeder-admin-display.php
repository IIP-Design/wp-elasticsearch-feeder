			...
			<div id="post-body-content">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">						
						...
						<div class="inside">
                            <input type="text" placeholder="http://localhost:9200/" class="regular-text" id="es_url" name="<?php echo $this->plugin_name; ?>[es_url]" value="
                                                                                                                                      <?php
                                                                                                                                      if ( ! empty( $es_url ) ) {
                                                                                                                                        echo $es_url;}
                                                                                                                                      ?>
                       ...
                       <div class="inside">
                          <input type="text" placeholder="api token" class="regular-text" id="es_token" name="<?php echo $this->plugin_name; ?>[es_token]" value="
                                                                                                                         <?php
                                                                                                                          if ( ! empty( $es_token ) ) {
                                                                                                                            echo $es_token;}
                                                                                                                          ?>
...
<!--						</div>-->
                        ...
                        <div class="inside">
                            <label>
                                <input type="checkbox" id="es_api_data" name="<?php echo $this->plugin_name; ?>[es_api_data]" value="1" <?php echo $es_api_data ? 'checked' : ''; ?>/>
                        ...
                        <div class="inside">
                            <label>
                                <input type="checkbox" id="es_post_language" name="<?php echo $this->plugin_name; ?>[es_post_language]" value="1" <?php echo $es_post_language ? 'checked' : ''; ?>/>
                        ...
                        <div class="inside">
                            <label>
                                <input type="checkbox" id="es_post_owner" name="<?php echo $this->plugin_name; ?>[es_post_owner]" value="1" <?php echo $es_post_owner ? 'checked' : ''; ?>/>
...
<!--							<input class="button-secondary" type="button" id="es_delete_index" name="es_delete_index" value="--><?php // esc_attr_e( 'Delete Index' ); ?><!--" />-->
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside manage-btns">
                            <button class="button-secondary" type="button" id="truncate_logs"><?php esc_attr_e( 'Clear Log' ); ?></button>
                            <a class="button-secondary" href="<?php echo plugin_dir_url( '/wp-elasticsearch-feeder/callback.log' ); ?>callback.log"><?php esc_attr_e( 'Download Log' ); ?></a>
                        </div>
                        <div class="inside log-wrapper">
                            ...
                            <textarea rows="20" id="log_text" readonly style="width: 100%; overflow-y: scroll;"><?php echo $log; ?></textarea>
                        </div>
                    </div>
				</div>
			</div>
